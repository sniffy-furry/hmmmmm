...
// placeholder in the various browser panels, even though the name is already
// known. Call RegisterKnownNames() once at startup (see AppShell::Init, right
// after Logger::Init) so HashResolver::Resolve() returns readable names for
