// VanGUI: standalone example application for SDL3 + OpenGL
...
int main(int, char**)
{
    ...
    SDL_Window* window = SDL_CreateWindow("VanGUI SDL3+OpenGL3 example", (int)(1280 * main_scale), (int)(800 * main_scale), window_flags);
    if (window == nullptr)
    {
    ...
    VanGui_ImplSDL3_InitForOpenGL(window, gl_context);
