...
cl /Zi /MD /utf-8 /I.. /I..\.. /I%SDL2_DIR%\include main.cpp ..\..\backends\vangui_impl_sdl2.cpp ..\..\backends\vangui_impl_opengl3.cpp ..\..\vangui*.cpp /FeDebug/example_sdl2_opengl3.exe /FoDebug/ /link /libpath:%SDL2_DIR%\lib\x86 SDL2.lib SDL2main.lib opengl32.lib /subsystem:console
#                 ^^ include paths                  ^^ source files                                                                                    ^^ output exe                    ^^ output dir   ^^ libraries
# or for 64-bit:
cl /Zi /MD /utf-8 /I.. /I..\.. /I%SDL2_DIR%\include main.cpp ..\..\backends\vangui_impl_sdl2.cpp ..\..\backends\vangui_impl_opengl3.cpp ..\..\vangui*.cpp /FeDebug/example_sdl2_opengl3.exe /FoDebug/ /link /libpath:%SDL2_DIR%\lib\x64 SDL2.lib SDL2main.lib opengl32.lib /subsystem:console
```
...
c++ `sdl2-config --cflags` -I .. -I ../.. -I ../../backends
  main.cpp ../../backends/vangui_impl_sdl2.cpp ../../backends/vangui_impl_opengl3.cpp ../../vangui*.cpp
...
- You may also refer to our [Continuous Integration setup](https://github.com/ocornut/vangui/tree/master/.github/workflows) for Emscripten setup.
