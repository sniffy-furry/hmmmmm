// VanGUI: standalone example application for SDL3 + DirectX 11
...
int main(int, char**)
{
    ...
    SDL_Window* window = SDL_CreateWindow("VanGUI SDL3+DirectX11 example", (int)(1280 * main_scale), (int)(800 * main_scale), window_flags);
    if (window == nullptr)
    {
    ...
    VanGui_ImplSDL3_InitForD3D(window);
