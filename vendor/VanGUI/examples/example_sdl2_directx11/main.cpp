// VanGUI: standalone example application for SDL2 + DirectX 11
...
int main(int, char**)
{
    ...
    SDL_Window* window = SDL_CreateWindow("VanGUI SDL2+DirectX11 example", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, (int)(1280 * main_scale), (int)(800 * main_scale), window_flags);
    if (window == nullptr)
    {
    ...
    VanGui_ImplSDL2_InitForD3D(window);
