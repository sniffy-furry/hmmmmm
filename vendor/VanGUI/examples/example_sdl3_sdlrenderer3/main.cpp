// VanGUI: standalone example application for SDL3 + SDL_Renderer
...
int main(int, char**)
{
    ...
    SDL_Window* window = SDL_CreateWindow("VanGUI SDL3+SDL_Renderer example", (int)(1280 * main_scale), (int)(800 * main_scale), window_flags);
    if (window == nullptr)
    {
    ...
    VanGui_ImplSDL3_InitForSDLRenderer(window, renderer);
    VanGui_ImplSDLRenderer3_Init(renderer);
...
#endif
    {
        ...
        VanGui_ImplSDLRenderer3_NewFrame();
        ...
        VanGui_ImplSDLRenderer3_RenderDrawData(VanGui::GetDrawData(), renderer);
    ...
    VanGui_ImplSDLRenderer3_Shutdown();
