// VanGUI: standalone example application for using SDL2 + WebGPU
...
int main(int, char**)
{
    ...
    SDL_Window* window = SDL_CreateWindow("VanGUI SDL2+WebGPU example", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, wgpu_surface_width, wgpu_surface_height, window_flags);
    if (window == nullptr)
    {
    ...
    VanGui_ImplSDL2_InitForOther(window);
