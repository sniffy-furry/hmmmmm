...
typedef struct
{
	...
	uSynergyCookie					m_cookie;										/* Cookie pointer passed to callback functions (can be nullptr) */
	uSynergyTraceFunc				m_traceFunc;									/* Function for tracing status (can be nullptr) */
