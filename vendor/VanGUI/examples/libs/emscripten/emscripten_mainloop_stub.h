...
// - Since VanGUI 1.00 we took pride that most of our examples applications had their entire
...
//   Especially as we are trying hard to convey that using a VanGUI backend in an *existing application*
...
//   As a stance and principle of VanGUI development we don't use C++ headers and we don't
...
// - Technique is based on this idea: https://github.com/ocornut/vangui/pull/2492/
