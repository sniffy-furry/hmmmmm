// VanGUI: standalone example application for using SDL3 + WebGPU
...
int main(int, char**)
{
    ...
    SDL_Window* window = SDL_CreateWindow("VanGUI SDL3+WebGPU example", wgpu_surface_width, wgpu_surface_height, window_flags);
    if (window == nullptr)
    {
    ...
    VanGui_ImplSDL3_InitForOther(window);
