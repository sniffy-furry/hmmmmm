...
- Please browse the [Wiki](https://github.com/ocornut/vangui/wiki) to find code snippets, links and other resources (e.g. [Getting Started](https://github.com/ocornut/vangui/wiki/Getting-Started), [Useful extensions](https://github.com/ocornut/vangui/wiki/Useful-Extensions)).
- Please read [Getting Started](https://github.com/ocornut/vangui/wiki/Getting-Started) if your question relates to setting up VanGUI.
- Please read [docs/FAQ.md](https://github.com/ocornut/vangui/blob/master/docs/FAQ.md).
- Please read [docs/FONTS.md](https://github.com/ocornut/vangui/blob/master/docs/FONTS.md) if your question relates to fonts or text.
- Please run `VanGui::ShowDemoWindow()` to explore the demo and its sources.
...
- You may [browse issues by Labels](https://github.com/ocornut/vangui/labels).
...
We are happy to use 'Issues' for many type of open-ended questions. We are encouraging 'Issues' becoming an enormous, centralized and cross-referenced database of VanGUI contents.

Only if you:
- Cannot BUILD or LINK examples.
- Cannot BUILD, or LINK, or RUN VanGUI in your application or custom engine.
- Cannot LOAD a font.

Then please [use the Discussions forums](https://github.com/ocornut/vangui/discussions) instead of opening an issue.

If VanGUI is successfully showing in your app and you have used VanGUI before, you can open an Issue. Any form of discussions is welcome as a new issue.
...
- Article: [How To Ask Good Questions](https://bit.ly/3nwRnx1).
- **PLEASE DO FILL THE REQUESTED NEW ISSUE TEMPLATE.** Including VanGUI version number, branch name, platform/renderer back-ends (vangui_impl_XXX files), operating system.
...
- **Please make sure that your project has asserts enabled.** Calls to VAN_ASSERT() are scattered in the code to help catch common issues. When an assert is triggered read the comments around it. By default VAN_ASSERT() calls the standard assert() function. To verify that your asserts are enabled, add the line `VAN_ASSERT(false);` in your main() function. Your application should display an error message and abort. If your application doesn't report an error, your asserts are disabled.
- Please state if you have made substantial modifications to your copy of VanGUI or the back-end.
- If you are not calling VanGUI directly from C++, please provide information about your Language and the wrapper/binding you are using.
...
If you have been using VanGUI for a while or have been using C/C++ for several years or have demonstrated good behavior here, it is ok to not fulfill every item to the letter. Those are guidelines and experienced users or members of the community will know which information is useful in a given context.
...
Any code you submit will become part of the repository and be distributed under the [VanGUI license](https://github.com/ocornut/vangui/blob/master/LICENSE.txt). By submitting code to the project you agree that the code is your work and that you can give it to the project.
